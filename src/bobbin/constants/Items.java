...
public class Items {
    public static final Item BED = new Item(
            Settings.MESSAGES_BUNDLE.getString("Items.BED.name"),
            Settings.MESSAGES_BUNDLE.getString("Items.BED.description"));

    public static final Item BLUEBERRY =
            new Item(
                    Settings.MESSAGES_BUNDLE.getString("Items.BLUEBERRY.name"),
    ...
    public static final Item WATER = new Item(
            Settings.MESSAGES_BUNDLE.getString("Items.WATER.name"),
